...
$ret=mysqli_query($bd, "update course set courseCode='$coursecode',courseName='$coursename', semester = '$semester',
courseUnit='$courseunit',moocCourseName = '$moocCourseName',moocLink = '$moocLink', details = '$details',
...
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="coursecode" name="coursecode"
                                        placeholder="Course Code" value="<?php echo htmlentities($row['courseCode']);?>"
                                        required />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="coursename" name="coursename"
                                        placeholder="Course Name" value="<?php echo htmlentities($row['courseName']);?>"
                                        required />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="courseunit" name="courseunit"
                                        placeholder="Course Unit" value="<?php echo htmlentities($row['courseUnit']);?>"
                                        required />
                                </div>
